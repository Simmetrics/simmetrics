...
public class SmithWatermanGotohTest extends StringMetricTest {
	...
	protected T[] getTests() {
		return new T[] {
				...
				new T(0.0960f, "Web Database Applications", "Structural Assessment: The Role of Large and Full-Scale Testing"),
				...
				new T(0.7333f, "Web Aplications", "Building Database Applications on the Web Using PHP3"),
				...
				new T(0.7333f, "Web Aplications", "WebRAD: Building Database Applications on the Web with Visual FoxPro and Web Connection"),
				new T(0.1333f, "Web Aplications", "Structural Assessment: The Role of Large and Full-Scale Testing"),
