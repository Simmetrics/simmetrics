...
public class SoundexTest extends StringMetricTest {
	...
	protected T[] getTests() {
		return new T[] {
				...
				new T(0.9333f, "aaa bbb ccc ddd", "aaa bbb ccc eee"),
				new T(0.9333f, "a b c d", "a b c e"),
				...
				new T(0.8133f, "Healed", "Help"),
				new T(0.9200f, "Sam J Chapman", "Samuel John Chapman"),
				...
				new T(0.4333f, "Web Database Applications",
						"Creating Database Web Applications with PHP and ASP"),
				new T(0.4667f, "Web Database Applications",
						"Building Database Applications on the Web Using PHP3"),
				new T(0.4667f, "Web Database Applications",
						"Building Web Database Applications with Visual Studio 6"),
				new T(0.8133f, "Web Database Applications",
