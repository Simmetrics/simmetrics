	...
	public void test() {
		testSimilarity(
				...
				new T[] {
						...
						new T(0.8444f, "Web Database Applications",
								"Web Application Development With PHP"),
						new T(
								1.0000f,
								"Web Database Applications",
								"WebRAD: Building Database Applications on the Web with Visual FoxPro and Web Connection"),
						new T(0.4000f, "Web Database Applications",
								"Structural Assessment: The Role of Large and Full-Scale Testing"),
						new T(0.8667f, "Web Database Applications",
								"How to Find a Scholarship Online"),
						new T(0.9545f, "Web Aplications",
								"Web Database Applications with PHP & MySQL"),
						new T(0.9545f, "Web Aplications",
								"Creating Database Web Applications with PHP and ASP"),
						...
						new T(0.9545f, "Web Aplications",
								"Building Web Database Applications with Visual Studio 6"),
						new T(0.9091f, "Web Aplications",
								"Web Application Development With PHP"),
						new T(
								1.0000f,
								"Web Aplications",
								"WebRAD: Building Database Applications on the Web with Visual FoxPro and Web Connection"),
						new T(0.4333f, "Web Aplications",
								"Structural Assessment: The Role of Large and Full-Scale Testing"),
