...
import org.simmetrics.similaritymetrics.Levenshtein;
...
public class LevenshteinTest extends SimplyfingStringMetricTest {
	...
	public T[] getTests() {
		return new T[] {
				...
				new T(0.4510f, "Web Database Applications", "Creating Database Web Applications with PHP and ASP"),
				...
				new T(0.2874f, "Web Database Applications", "WebRAD: Building Database Applications on the Web with Visual FoxPro and Web Connection"),
				new T(0.1587f, "Web Database Applications", "Structural Assessment: The Role of Large and Full-Scale Testing"),
				new T(0.1563f, "Web Database Applications", "How to Find a Scholarship Online"),
				new T(0.3571f, "Web Aplications", "Web Database Applications with PHP & MySQL"),
				new T(0.2941f, "Web Aplications", "Creating Database Web Applications with PHP and ASP"),
				new T(0.2500f, "Web Aplications", "Building Database Applications on the Web Using PHP3"),
				new T(0.2727f, "Web Aplications", "Building Web Database Applications with Visual Studio 6"),
				new T(0.3889f, "Web Aplications", "Web Application Development With PHP"),
