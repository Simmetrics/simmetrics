...
public class OverlapCoefficientTest extends InterfaceStringMetricTest {
	...
	public T[] getTests() {
		return new T[] {
				...
				new T(0.5000f, "Web Aplications", "Web Database Applications with PHP & MySQL"),
				new T(0.5000f, "Web Aplications", "Creating Database Web Applications with PHP and ASP"),
				new T(0.5000f, "Web Aplications", "Building Database Applications on the Web Using PHP3"),
				new T(0.5000f, "Web Aplications", "Building Web Database Applications with Visual Studio 6"),
